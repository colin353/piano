...
export class Engine {
     ...
     * @param {number} value
     */
    set_control(controller, value) {
        wasm.engine_set_control(this.__wbg_ptr, controller, value);
    }
    /**
     * @param {number} position
     */
    set_sustain(position) {
        wasm.engine_set_sustain(this.__wbg_ptr, position);
    }
    /**
     ...
     */
    render(frames) {
        wasm.engine_render(this.__wbg_ptr, frames);
    }
    /**
     * @param {number} note
    ...
    note_on(note, velocity) {
        wasm.engine_note_on(this.__wbg_ptr, note, velocity);
    }
    /**
     * @returns {number}
     */
     ...
     */
    note_off(note) {
        wasm.engine_note_off(this.__wbg_ptr, note);
    }
    /**
     * @returns {number}
     */
    ...
    set_param(name, value) {
        ...
        wasm.engine_set_param(this.__wbg_ptr, ptr0, len0, value);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('piano_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
